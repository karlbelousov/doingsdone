    ...
    <footer className="main-footer">
      <div className="container">
        ...
        <div className="main-footer__social social">
          <span className="visually-hidden">Мы в соцсетях:</span>
          ...
          <span className="visually-hidden">,</span>
          <a className="social__link social__link--vkontakte" href="#">
        ...
        <div className="main-footer__developed-by">
          <span className="visually-hidden">Разработано:</span>
